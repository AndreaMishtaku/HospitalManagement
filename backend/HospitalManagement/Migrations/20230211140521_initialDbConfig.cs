        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ProducedAt = table.Column<DateTime>(type: "datetime2", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Menu_AspNetRoles_RoleId",
                        column: x => x.RoleId,
                        principalTable: "AspNetRoles",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ServiceEquipment", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ServiceEquipment_Equipment_EquipmentId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ServiceDoctorId = table.Column<int>(type: "int", nullable: true),
                    DateCreated = table.Column<DateTime>(type: "datetime2", nullable: true),
                    DateCanceled = table.Column<DateTime>(type: "datetime2", nullable: true),
                    CanceledByStaffId = table.Column<int>(type: "int", nullable: true),
                    CanceledByClientId = table.Column<int>(type: "int", nullable: true),
                    PostponedById = table.Column<int>(type: "int", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Reservation", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Reservation_AspNetUsers_EmployeeId",
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Reservation_ServiceStaff_ServiceDoctorId",
                        column: x => x.ServiceDoctorId,
                        principalTable: "ServiceStaff",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 1, "61ac4f09-c1e7-43cf-9288-a24cb9065d08", "Manager", "MANAGER" });

            migrationBuilder.InsertData(
                table: "AspNetRoles",
                columns: new[] { "Id", "ConcurrencyStamp", "Name", "NormalizedName" },
                values: new object[] { 2, "daf399e2-83b7-47c7-8483-a52f602635ee", "Staff", "STAFF" });

            migrationBuilder.InsertData(
                table: "AspNetRoles",
                columns: new[] { "Id", "ConcurrencyStamp", "Name", "NormalizedName" },
                values: new object[] { 3, "9e77626c-8df3-4c87-aeac-7b46de9c7ed1", "Reception", "RECEPTION" });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Reservation_ServiceDoctorId",
                table: "Reservation",
                column: "ServiceDoctorId");

            migrationBuilder.CreateIndex(
                name: "IX_ServiceEquipment_EquipmentId",
